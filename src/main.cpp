...
// Window size
int display_width = Chip8::SCREEN_WIDTH * modifier;
int display_height = Chip8::SCREEN_HEIGHT * modifier;
...
uint8_t screenData[Chip8::SCREEN_HEIGHT][Chip8::SCREEN_WIDTH][3]; 
void setupTexture();
...
void setupTexture()
{
	...
	// Create a texture 
	glTexImage2D(GL_TEXTURE_2D, 0, 3, Chip8::SCREEN_WIDTH, Chip8::SCREEN_HEIGHT, 0, GL_RGB, GL_UNSIGNED_BYTE, (GLvoid*)screenData);
...
{	
	...
	// Update Texture
	glTexSubImage2D(GL_TEXTURE_2D, 0 ,0, 0, Chip8::SCREEN_WIDTH, Chip8::SCREEN_HEIGHT, GL_RGB, GL_UNSIGNED_BYTE, (GLvoid*)screenData);
